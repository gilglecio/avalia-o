...
class Issue extends Model
{
     ...
     * @var bool
     */
    protected $accepted_justification;

    /**
     * @var bool
     */
    protected $justification_required;
     ...
     * @var int
     */
    protected $min_choice;

    /**
     * @var int
     */
    protected $max_choice;
    ...
    public function newScale(array $input)
    {
        foreach ($input['label'] as $key => $label) {
            if ($label) {
                $input['label'][$key] = ucwords(trim(strip_tags($label)));
            }
        }
